    ...
    return Scaffold(
      ...
      bottomNavigationBar: Padding(
        ...
        child: CustomButtons.submitButton(
          ...
          text: widget.section == null ? 'Create Module' : 'Update Module',
      ...
      body: SingleChildScrollView(
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              buildTextField(context, controller: nameCtlr, hint: 'Enter Module Title', title: 'Module Title *', hasImageUpload: false),
            ],
          ),
        ),
      ),
