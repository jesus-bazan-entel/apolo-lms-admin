...
final geminiApiKeyTextfieldProvider = Provider<TextEditingController>((ref) => TextEditingController());
...
final appSettingsProvider = FutureProvider<AppSettingsModel?>((ref) async {
  ...
  if (settings != null) {
    ...
    ref.read(geminiApiKeyTextfieldProvider).text = settings.geminiApiKey ?? '';
